...
export function NextPageBtn({ pageNum }) {
  return (
    <div className="flex items-center justify-center border dark:border-white rounded-sm border-slate-500 hover:cursor-pointer dark:hover:bg-slate-600 hover:bg-slate-200 transition duration-200 aspect-square px-0.5">
